...
function single_post() {
    ...
    if (isset($_GET['post_id'])) {
        ...
        <div class='row'>
            ...
            <div id='posts' class='col-sm-6' style='background-color: #fff; border-radius: 10px; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.1);'>
                <div class='row'>
                    ...
                    <div class='col-sm-6'>
                        <h3><a style='text-decoration:none; color: #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
                        <h4><small style='color:gray;'>Updated a post on <strong>$post_date</strong></small></h4>
                    </div>
                </div>
                <div class='row'>
                    <div class='col-sm-12'>
        ...
        if ($content == "No" && strlen($upload_image) > 0) {
            ...
            echo "<p>$content</p><img id='posts-img' src='imagepost/$upload_image' style='object-fit: cover; width:100%; height:auto; border-radius: 10px; box-shadow: 0 0 5px rgba(0,0,0,0.1);'>";
        } else {
            echo "<p>$content</p>";
        }
