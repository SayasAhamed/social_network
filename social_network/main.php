...
<body>
	...
	<div class="row">
		<div class="col-sm-6" style="left:0.5%;">
			<img src="images/SocialHub sidepage.jpg" class="img-rounded" title="Coding cafe" width="650px" height="565px">
		...
		<div class="col-sm-6" style="left:8%:">
			<img src="images/SocialHub Logo.png" class="img-rounded" title="Coding cafe" width="270px" height="200px">
			<h2><strong>See what's happening in <br> the world right now</strong></h2><br><br>
			<h4><strong>join Social Hub Today.</strong></h4>
